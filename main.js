...
for (var i=0; i<bluePieces.length; i++){
    bluePieces[i].addEventListener("click", function() { showMoves(this); });
}
for (var i=0; i<redPieces.length; i++){
    redPieces[i].addEventListener("click", function() { showMoves(this); });
}
...
function showMoves(piece) {
    ...
    // regarde toute les cases du tableau et enlève les cases vertes après un click
    function resetBoard() {
